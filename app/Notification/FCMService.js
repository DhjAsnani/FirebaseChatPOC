...
class FCMService {
    ...
    createNotificationListeners = (onRegister, onNotification, onOpenNotification) => {
        ...
        this.messageListener = messaging().setBackgroundMessageHandler(async remoteMessage => {
            console.log("BACKGROUND MSG : [FCMService] A new FCm message arrived", remoteMessage);
            if (remoteMessage) {
                let notification = null;
                if (Platform.OS === 'ios') {
                    notification = remoteMessage.data
